...
class CashcardApplicationTests {
	...
	void shouldReturnACashCardWhenDataIsSaved() {
		ResponseEntity<String> responseEntity = restTemplate.withBasicAuth("sarah1", "abc123").getForEntity("/cashcards/99", String.class);
	...
	void shouldNotReturnACashCardWithAnUnknownId(){
		ResponseEntity<String> responseEntity = restTemplate.withBasicAuth("sarah1", "abc123").getForEntity("/cashcards/1000",String.class);
...
//		CashCard newCashCard = new CashCard(null, 250.00,"sarah1");
	...
	/**
	 * where a user tries to update a Cash Card which doesn't exist
	 */
	@Test
	...
	/**
	 * where a user tries to update a Cash Card they don't own
	 */
	@Test
	...
	@Test
	@DirtiesContext //add this annotation to all tests which change the data
	...
	void shouldNotAllowDeletionOfCashCardsTheyDoNotOwn() {
		...
		//to verify that the record you tried unsuccessfully to delete is still there
		ResponseEntity<String> getResponse = restTemplate
